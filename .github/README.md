...
[`@aws-sdk/client-route-53-domains`](https://www.npmjs.com/package/@aws-sdk/client-route-53-domains/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route-53-domains@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r0GizIkQr4CIJ7px2i3eBld91LySHNUD+K7N+DUWRFgObImc2XPr7PLSs6B8VPlI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route-53-domains": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route-53-domains@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route-53-domains@3.569.0/index.min.mjs": "sha384-r0GizIkQr4CIJ7px2i3eBld91LySHNUD+K7N+DUWRFgObImc2XPr7PLSs6B8VPlI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route-53-domains/blob/refs/tags/3.569.0/LICENSE
```
