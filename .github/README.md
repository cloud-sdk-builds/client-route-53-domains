...
[`@aws-sdk/client-route-53-domains`](https://www.npmjs.com/package/@aws-sdk/client-route-53-domains/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route-53-domains@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8xVSk5H+B+ww34EFYJeXpp6nF+Q4/P1XMT9VbCeMLobl9bMfPaa399dxgmPFCsOo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route-53-domains": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route-53-domains@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route-53-domains@3.484.0/index.min.mjs": "sha384-8xVSk5H+B+ww34EFYJeXpp6nF+Q4/P1XMT9VbCeMLobl9bMfPaa399dxgmPFCsOo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-route-53-domains/blob/refs/tags/3.484.0/LICENSE
```
